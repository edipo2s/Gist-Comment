 ...
 * @param <T>
 *
 * @see <a href="https://github.com/googlesamples/android-architecture-components/blob/master/GithubBrowserSample/app/src/main/java/com/android/example/github/api/ApiResponse.java">Source</a>
 */
class ApiResponse<T> {
    ...
    constructor(error: Throwable, errorCode: Int? = null) {
        code = errorCode ?: 500
        body = null
